...
function SignUp() {
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up - Stylo Resume Builder</title> {/* Page Title */}
        <meta name="description" content="Create an account on Stylo Resume Builder to easily build and manage your resume." /> {/* Meta Description */}
