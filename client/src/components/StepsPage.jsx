...
function StepsPage() {
  return (
    <div className='contain mx-20'>
                <h2 className="text-center text-4xl my-10 font-bold">Here’s how Stylo Resume Builder works:</h2>
      <div className='flex flex-col lg:flex-row mt-20 lg:w-full'>
        <div className='flex flex-col mb-10 items-center lg:w-1/3 '>
          ...
          <div className='w-80 h-20 text-center m-2'>
            <p className='text-lg'>Explore our curated templates and step-by-step guidance to create a standout resume quickly.</p>
          </div>
        </div>
        <div className='flex flex-col mb-10 items-center lg:w-1/3'>
          <div className='mb-2'>
          ...
          <div className='w-80 h-20 text-center m-2'>
            <p className='text-lg'>Find the right words to showcase your skills. Just search by job title, and access pre-written content tailored to your expertise.</p>
          </div>
        </div>
        <div className='flex flex-col mb-10 items-center lg:w-1/3'>
          <div className='mb-2'>
          ...
          <div className='w-80 h-20 text-center m-2'>
            <p className='text-lg'>Fine-tune the details with our tools, generate each section with ease, and download your polished resume. You’re all set to apply!</p>
          </div>
        </div>
